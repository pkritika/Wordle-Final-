...
class BoardController: NSObject,
  ...
  private func applyNumLettersSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let setting = settings[kNumLettersKey] as? Int else{
          return
      }
      numItemsPerRow = setting
    // END YOUR CODE HERE
  ...
  private func applyNumGuessesSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let row = settings[kNumLettersKey] as? Int else{
          return
      }
      numRows = row
    // END YOUR CODE HERE
  ...
  private func applyThemeSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let theme = settings[kWordThemeKey] as? String,
            let final_theme = WordTheme(rawValue: theme) else{
          return
      }
      self.goalWord = WordGenerator.generateGoalWord(with: final_theme)
    // END YOUR CODE HERE
  }
  ...
  private func applyIsAlienWordleSettings(with settings: [String: Any]) {
    // START YOUR CODE HERE
    // ...
      guard let alien_word = settings[kIsAlienWordleKey] as? Bool else{
          return
      }
      self.isAlienWordle = alien_word
    // START YOUR CODE HERE
  }
}
